...
public class PlayerControllerTEST3SWAP : MonoBehaviour
{
	...
	[SerializeField] private TilemapCollider2D colorThreeTilemapCollider;
	...
	[SerializeField] private SpriteRenderer colorThreeSpriteRenderer;

	// Patrick adding a boolean for color 1 or color 2
	[SerializeField] public int currentColor = 1;
